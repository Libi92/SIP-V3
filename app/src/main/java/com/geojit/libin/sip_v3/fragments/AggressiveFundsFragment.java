 ...
 */
public class AggressiveFundsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_funds_aggressive, container, false);
    ...
    private void createDataSet() {
        ...
        funds = portfolioReturns.get(PortfolioReturns.AGGRESSIVE);
