 ...
 */
public class VeryAggressiveFundsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_funds_very_aggressive, container, false);
    ...
    private void createDataSet() {
        ...
        funds = portfolioReturns.get(PortfolioReturns.VERY_AGGRESSIVE);
