 ...
 */
public class ConservativeFundsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_funds_conservative, container, false);
    ...
    private void createDataSet() {
        ...
        funds = portfolioReturns.get(PortfolioReturns.CONSERVATIVE);
